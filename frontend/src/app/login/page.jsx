  ...
  return (
    <div className="flex flex-col min-h-screen justify-center items-center py-12 px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link href="/" className="inline-flex items-center gap-2 text-teal-600 font-extrabold text-3xl">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="glass py-8 px-6 shadow-xl rounded-2xl border border-slate-200">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-lg shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-slate-300 bg-white/50 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all text-sm"
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-lg shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2 border border-slate-300 bg-white/50 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all text-sm"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-600 hover:text-slate-600 focus:outline-none"
                >
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            <h4 className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-3">Seeded Demo Credentials</h4>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <button
                type="button"
                onClick={() => { setEmail('admin@haqms.com'); setPassword('password123'); }}
                className="text-left p-2 rounded bg-slate-100 hover:bg-teal-500/10 hover:text-teal-600 transition-colors text-slate-600"
              >
