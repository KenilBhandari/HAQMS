      ...
      <div className="max-w-4xl mx-auto w-full text-center mt-12 sm:mt-20">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 max-w-2xl mx-auto">
          ...
          <Link href="/login" className="group">
            <div className="glass p-8 rounded-2xl shadow-lg border border-slate-200 text-left hover:border-teal-500/50 hover:shadow-teal-500/10 transition-all duration-300 transform hover:-translate-y-1">
